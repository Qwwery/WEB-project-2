...
class Friends(SqlAlchemyBase):
    ...
    id_friends = sqlalchemy.Column(sqlalchemy.Integer, primary_key=True, autoincrement=True)
    ...
    def __repr__(self):
        return f"<Friend> id: {self.id_friends}; first_id: {self.first_id}; second_id: {self.second_id};" \
